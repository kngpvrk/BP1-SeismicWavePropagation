...
Other equations, such as stress-strain relationships, Gaussian functions and others, are implemented in the code but are not detailed here for brevity. For more detailed explanations, see the works of Chapman (2004), Achenbach (2012), and Bormann et al. (2012) listed in the [References](#references).
